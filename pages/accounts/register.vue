<template>
    <div class="max-w-md w-full p-6">
        ...
        <div class="mt-4 flex flex-col lg:flex-row items-center justify-between gap-4">
            <SocialSignInButton buttonType="button" :logoSrc="'/googleLogo.svg'" buttonText="Regístrate con Google" />
            <SocialSignInButton buttonType="button" :logoSrc="'/githubLogo.svg'" buttonText="Regístrate con Github" />
        </div>
